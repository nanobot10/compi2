...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\011\000\004\006\004\001\002\000\010\002\ufffd\004" +
    "\ufffd\005\ufffd\001\002\000\004\002\013\001\002\000\010" +
    "\002\000\004\010\005\007\001\002\000\004\006\004\001" +
    "\002\000\004\006\004\001\002\000\010\002\uffff\004\uffff" +
    "\005\007\001\002\000\010\002\ufffe\004\ufffe\005\ufffe\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Nodo val2 = (Nodo)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Suma((Nodo)val1,(Nodo)val2); 
		...
		int val2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Nodo val2 = (Nodo)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Multiplicacion( (Nodo)val1,(Nodo)val2); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("e",1, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String val = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Operando(Integer.valueOf(val)); 
